/*! Build 8ccf46d0b2d97eded7fff32a123918eb6156b07c:1685611423100 */ !(function(e) {
    var t = {}
                ...
                return Object.create({
                    ...
                    get: function(e) {
                        if ('undefined' !== typeof document && (!arguments.length || e)) {
                            for (
                                var t = document.cookie ? document.cookie.split('; ') : [], n = {}, o = 0; o < t.length; o++
                            ) {
                                var i = t[o].split('='),
                                    a = i.slice(1).join('=')
                                try {
    ...
    188: function(e, t, r) {
                ...
                (n = [{
                        ...
                        value: function(e, t, r) {
                            ...
                            return (
                                r ?
                                ((t.cookie = a({}, r)),
                                    r.expires && ((r.expires = new Date(r.expires)), delete t.cookie.expires),
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            try {
                                ...
                                return (
                                    console.warn("[Rewardful] Cookie '".concat(e, "' is not valid JSON.")),
                                    o.a.remove(e),
                                    null
                                )
                            }
                    ...
                    (n = [{
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                return t ?
                                    this.load(t) :
                                    (console.error('Referral.update() called but there is no stored referral.'),
                                        y(), !1)
                            },
                        },
                        {
            ...
            return (
                ...
                (r = [{
                    ...
                    },
                    {
                        key: 'hashToken',
                        get: function() {
                            return (!(!this._location || !this._location.hash) &&
        ...
        var P = function(e, t, r) {
                var n = e.elements[t]
                return (
                    n || (((n = document.createElement('input')).name = t), e.appendChild(n)),
                    (n.type = 'hidden'),
                    (n.value = r),
                    n
                )
                ...
                (n = [{
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            return this._setup ?
                                ...
                                (console.error('Rewardful.setup requires a `window` parameter.'), !1) :
                                (console.error('Rewardful.setup requires an `apiKey` parameter.'), !1) :
                                (console.error('Rewardful.setup requires an `apiKey` and `window` parameter.'), !1)
                        },
                    },
                    {
                        key: 'ready',
                    ...
                    },
                    {
                        ...
                        value: function() {
                            if (!this._setup)
                                return (
                                    console.error('Rewardful.setup() must be called before Rewardful.track().'), !1
                                )
                            if (this._tracked)
                                return console.warn('Rewardful.track() can only be called once.'), !1
                            var t = {}
                            return (
                                this.link.token && (t.link_token = this.link.token),
                                w.exists() && e.referral ?
                                (t.referral_id = e.referral) :
                                this.link.referral && (delete t.link_token, (t.id = this.link.referral)),
                    ...
                    },
                    {
                        key: 'source',
                        value: function(e) {;
                            (e = e && e.toString && e.toString().toLowerCase().replace(/\s+/g, '')) ?
                            (w.exists() && w.affiliate.token === e) || w.track({
                                link_token: e
                    ...
                    },
                    {
                        ...
                        get: function() {
                            return {
                                timestamp: 1685611423100,
                                sha: '8ccf46d0b2d97eded7fff32a123918eb6156b07c'
                            }
                        },
                    },
                    {
                            ...
                            value: function(e) {
                                ...
                                if ('undefined' === typeof n)
                                    return console.error(
                                        ''.concat(this.queueName, ' does not implement `').concat(t, '`'),
                                    )
                                try {
                                    n.apply(this.receiver, r)
                                } catch (o) {
                                    console.error(
                                            'Error executing `'.concat(this.queueName, '.').concat(t, '`: ').concat(o),
                                        ),
